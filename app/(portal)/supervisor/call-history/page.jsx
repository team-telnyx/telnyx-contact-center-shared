        ...
        <Card className="shadow-sm">
                ...
                {loading ? (
                  ...
                  items.map((item) => {
                    ...
                    const durationSeconds =
                      item.handle_time_seconds ||
                      (item.completed_at && startedAt
                        ? Math.floor(
                    ...
                    return (
                      <TableRow key={item.id}>
                        ...
                        <TableCell className="min-w-[140px]">
                          {item.from_name || item.from_number || "-"}
                        </TableCell>
                        <TableCell className="min-w-[140px]">
                          {item.to_name || item.to_number || "-"}
                        </TableCell>
                        <TableCell>{item.queue_name || "-"}</TableCell>
                        <TableCell>
                          {item.agent_name || item.agent_username || "-"}
                        </TableCell>
          ...
          <div className="border-t pt-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <SelectTrigger className="w-[110px] rounded-full px-4">
