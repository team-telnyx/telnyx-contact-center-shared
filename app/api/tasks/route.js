...
export const GET = withPermission("tasks:read", GET_handler, { apiKey: requireAiApiKey, route: "/api/tasks" });
export const POST = withPermission("tasks:create", POST_handler, { apiKey: requireAiApiKey, route: "/api/tasks" });
