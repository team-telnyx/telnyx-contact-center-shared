...
Supported field types: section, row, columns, grid, flex, spacer, divider, codeblock, hero, stats, card, richtext, label, text, textarea, select, radio, checkbox, button, image, context_value, hidden.
...
For layout blocks, create fields with type section/row/columns/grid/flex/divider/codeblock and visual props only; keep layout.order compatible with existing flat arrays. For codeblock fields, put the code in props.code and language in props.language (for example json, javascript, typescript, python, bash, sql).
