...
export const GET = withPermission("skills:read", GET_handler, { route: "/api/admin/skills" });
export const POST = withPermission("skills:create", POST_handler, { route: "/api/admin/skills" });
