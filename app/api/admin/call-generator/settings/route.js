...
export const GET = withPermission("call_generator:read", GET_handler, { route: "/api/admin/call-generator/settings" });
export const PUT = withPermission("call_generator:update", PUT_handler, { route: "/api/admin/call-generator/settings" });
