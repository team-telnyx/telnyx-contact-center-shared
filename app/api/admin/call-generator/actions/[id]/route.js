...
export const PUT = withPermission("call_generator:update", PUT_handler, { route: "/api/admin/call-generator/actions/[id]" });
export const DELETE = withPermission("call_generator:delete", DELETE_handler, { route: "/api/admin/call-generator/actions/[id]" });
