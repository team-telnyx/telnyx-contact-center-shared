...
export const GET = withPermission("domains:read", GET_handler, { route: "/api/admin/domains" });
export const POST = withPermission("domains:create", POST_handler, { route: "/api/admin/domains" });
