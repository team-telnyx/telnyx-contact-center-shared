...
export const GET = withPermission("statuses:read", GET_handler, { route: "/api/admin/statuses" });
export const POST = withPermission("statuses:create", POST_handler, { route: "/api/admin/statuses" });
