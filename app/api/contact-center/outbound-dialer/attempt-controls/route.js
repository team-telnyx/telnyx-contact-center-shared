...
function normalizeAttemptControl(body = {}) {
  return {
    ...
    max_attempts_per_contact: normalizeInt(body.max_attempts_per_contact ?? body.maxAttemptsPerContact, 4, 1, 5),
    max_attempts_per_number: normalizeInt(body.max_attempts_per_number ?? body.maxAttemptsPerNumber, 2, 1, 5),
