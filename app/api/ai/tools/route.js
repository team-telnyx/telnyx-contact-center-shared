...
export const GET = withPermission("ai_tools:read", GET_handler, { route: "/api/ai/tools" });
export const POST = withPermission("ai_tools:create", POST_handler, { route: "/api/ai/tools" });
