...
export default function SpeakNodeEditor({
  config = {},
  onChange,
  availableVariables = [],
}) {
  ...
  useEffect(() => {
    console.log("[SpeakNodeEditor] Config updated:", {
      voice: config.voice,
  ...
  const handleTest = async () => {
    ...
    console.log("[SpeakNodeEditor] Testing voice with:", {
      voice,
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => {
              ...
              console.log("[SpeakNodeEditor] API key changed:", {
