...
// 3. Healthcare Intake (sample)
{
  ...
  description: "Medical transport intake workflow for medical transport dispatch - caller ID, patient info, transport details.",
  category: "healthcare",
  stages: [
  {
    ...
    order_index: 0,
    items: [
    { type: "action", label: "Greet caller with brand name", prompt_hint: "hello, this is Acme Air Medical, thank you for calling", order_index: 0 },
