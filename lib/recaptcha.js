 ...
 * Docs: https://developers.google.com/recaptcha/the internal documentation
 */
...
export async function verifyRecaptcha(
  ...
  if (!secretKey) {
    authLogger.error("recaptcha_secret_missing", { configured: false });
    return {
      success: false,
  ...
  try {
    ...
    authLogger.info("recaptcha_verification_completed", {
    ...
    authLogger.error("recaptcha_verification_failed", { ...securityErrorPayload(error) });
    return {
      success: false,
