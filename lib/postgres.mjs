...
function getDbRuntimeLoggingConfig() {
  ...
  return {
    ...
    topicLevels: {
      ...
      "platform.db": process.env.LOG_DB_LEVEL || runtimeConfig.topicLevels?.["platform.db"] || runtimeConfig.topicLevels?.db || "info",
    },
  };
}
...
const dbLogger = createLogger({
  ...
  config: {
    ...
    topicLevels: { "platform.db": process.env.LOG_DB_LEVEL || "info" },
    topicEnabled: { "platform.db": true },
  },
