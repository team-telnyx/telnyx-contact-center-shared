  ...
  devtools(
    (set, get) => ({
      ...
      syncCallMetricsToDb: async () => {
        ...
        if (!state.contactCenter?.interactionId) {
          console.log(
        ...
        try {
          ...
          const metrics = {
            interactionId: state.contactCenter.interactionId,
          ...
          const res = await fetch(
            `/api/contact-center/interactions/${state.contactCenter.interactionId}/metrics`,
            {
              method: "POST",
