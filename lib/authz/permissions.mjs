...
const AGENT_KEYS = ["screen:agent.*", "agent:self", "interactions:read", "kb_articles:read", "forms:read", "contacts:read", "tasks:read", "web_pages:read"];
const SUPERVISOR_KEYS = [
  ...
  "monitor:read", "reports:*", "interactions_history:read", "interactions:*", "recordings:*", "calls:*", "agents:*",
