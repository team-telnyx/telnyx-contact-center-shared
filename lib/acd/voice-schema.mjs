...
export async function ensureVoiceSchema(db) {
  await db.query(`
    ...
    ALTER TABLE acd_legs ADD CONSTRAINT acd_legs_role_check CHECK (role IN
      ('customer', 'agent_transport', 'agent_device', 'consult_target', 'consult_transport', 'transfer_target', 'transfer_transport', 'supervisor', 'handoff_target', 'handoff_transport', 'handoff_source'));
