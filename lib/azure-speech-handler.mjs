  ...
  connect() {
    ...
    this.ws.on("message", (data) => {
      try {
        ...
        console.log(`[AzureSpeech] ← Azure msg (track=${this.track}): RecognitionStatus=${msg.RecognitionStatus ?? "N/A"} Text="${msg.DisplayText ?? ""}" PrimaryLanguage=${msg.PrimaryLanguage?.Language ?? "N/A"}`);
