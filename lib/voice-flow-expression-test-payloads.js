  ...
  nodes.forEach((node) => {
    ...
    if (nodeType === "mcp_tool") {
      ...
      if (responsePayload !== undefined) {
        ...
        const responseText = typeof responsePayload === "string" ? responsePayload : testResponse.text || "";
        const structuredPayload = responsePayload && typeof responsePayload === "object"
          ? responsePayload
        ...
        addOption({
          ...
          payload: {
            [responseVariable]: getMcpResponseVariablePayload(testResponse),
