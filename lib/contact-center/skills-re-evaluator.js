  ...
  try {
    ...
    const userResult = await pool.query(
      `SELECT 
        ...
        u.first_name,
        u.last_name,
        ast.agent_status AS current_agent_status,
        u.skills,
    ...
    if (user.current_agent_status !== "Available") {
    ...
    for (const interaction of interactionsResult.rows) {
      ...
      try {
        ...
        try {
          ...
          routingLogger.error("skillsreevaluator", { ...contactCenterErrorPayload(audioError), interactionId: typeof interactionId !== "undefined" ? interactionId : typeof interaction !== "undefined" ? interaction?.id : undefined, callControlId: typeof callControlId !== "undefined" ? callControlId : typeof legId !== "undefined" ? legId : undefined, queueId: typeof queueId !== "undefined" ? queueId : undefined, agentUserId: typeof targetUserIdFinal !== "undefined" ? targetUserIdFinal : typeof userId !== "undefined" ? userId : typeof user !== "undefined" ? user?.id : undefined, reason: typeof reason !== "undefined" ? reason : undefined });
