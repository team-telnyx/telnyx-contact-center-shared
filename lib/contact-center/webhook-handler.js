    ...
    case "call.answered": {
      ...
      try {
        ...
        if (sttConfig?.enabled) {
          ...
          console.log(`[WebhookHandler] TelnyxSTT: starting selectedTracks=${selectedTracks}, callerStreamCcId=${streamCcId}, agentCcId=${agentCcId}, agent=${agentUsername}, engine=${sttConfig.transcription_engine}, model=${sttConfig.model}`);

          if (wantsInbound && wantsOutbound && streamCcId && streamCcId === agentCcId) {
          ...
          if (wantsOutbound && agentCcId && streamCcId !== agentCcId) {
            const outboundConfig = { ...sttConfig, transcription_tracks: "outbound" };
