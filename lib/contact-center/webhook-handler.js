...
export async function handleContactCenterEnqueue(params) {
  ...
  if (clientState) {
    try {
      ...
      console.log(`[WebhookHandler] handleContactCenterEnqueue - Parsed client_state:`, JSON.stringify(decoded, null, 2));
      console.log(`[WebhookHandler] handleContactCenterEnqueue - routingMetadata.call_priority:`, routingMetadata.call_priority);
    } catch (err) {
      console.error(`[WebhookHandler] handleContactCenterEnqueue - Failed to parse client_state:`, err);
      // Failed to parse client_state
    }
  } else {
    console.warn(`[WebhookHandler] handleContactCenterEnqueue - No clientState provided`);
  }
  ...
  console.log(`[WebhookHandler] handleContactCenterEnqueue - callPriority determined:`, {
    from_routingMetadata: routingMetadata.call_priority,
    from_queue_default: queue.default_call_priority,
    final: callPriority,
    routingMetadata_keys: Object.keys(routingMetadata),
  });
