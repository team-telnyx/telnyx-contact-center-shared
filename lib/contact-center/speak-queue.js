...
import { VoiceFlowDb } from "../pgdb-voice-flows.js";
import { PgDb } from "../pgdb.js";
import { contactCenterErrorPayload, queuesLogger } from "./logging.mjs";
...
const TRANSCRIPTION_CONFIG_VAR = "__transcription_config";

function extractTranscriptionConfigFromFlow(flow) {
  const nodes = flow?.nodes || [];
  for (const node of nodes) {
    const config = node?.data?.config || {};
    if (config.transcription_engine) {
      const extracted = {
        transcription_engine: config.transcription_engine,
      };
      if (
        config.transcription_engine_config &&
        Object.keys(config.transcription_engine_config).length > 0
      ) {
        extracted.transcription_engine_config = config.transcription_engine_config;
      }
      if (config.transcription_tracks) {
        extracted.transcription_tracks = config.transcription_tracks;
      }
      if (config.transcription_model) {
        extracted.transcription_model = config.transcription_model;
      }
      if (config.language) {
        extracted.language = config.language;
      }
      return extracted;
    }
  }
...
async function getTranscriptionConfigForCall(callControlId) {
  ...
  try {
    ...
    const variables =
      execution.variables && typeof execution.variables === "object"
        ? execution.variables
        : {};

    if (variables[TRANSCRIPTION_CONFIG_VAR]) {
      return variables[TRANSCRIPTION_CONFIG_VAR];
    }

    if (execution.flow_id) {
      const flow = await VoiceFlowDb.getFlowById(execution.flow_id, null);
      const extracted = extractTranscriptionConfigFromFlow(flow);
      if (extracted?.transcription_engine) {
        const updatedVariables = {
          ...variables,
          [TRANSCRIPTION_CONFIG_VAR]: extracted,
        };
...
async function stopTranscription(callControlId) {
  try {
    const legIds = await getTranscriptionCallLegs(callControlId);
    if (legIds.length === 0) return;

    await Promise.all(
      legIds.map(async (legId) => {
        const url = buildTelnyxV2Url(
          `/calls/${encodeURIComponent(legId)}/actions/transcription_stop`
        );
        await fetch(url, {
          method: "POST",
          headers: { Authorization: `Bearer ${getApiKey()}` },
        });
        pausedTranscriptions.set(legId, true);
        queuesLogger.debug("speakqueue", { interactionId: typeof interactionId !== "undefined" ? interactionId : typeof interaction !== "undefined" ? interaction?.id : undefined, callControlId: typeof callControlId !== "undefined" ? callControlId : typeof legId !== "undefined" ? legId : undefined, queueId: typeof queueId !== "undefined" ? queueId : undefined, agentUserId: typeof targetUserIdFinal !== "undefined" ? targetUserIdFinal : typeof userId !== "undefined" ? userId : typeof user !== "undefined" ? user?.id : undefined, reason: typeof reason !== "undefined" ? reason : undefined });
      })
    );
  } catch (err) {
    queuesLogger.warn("speakqueue", { ...contactCenterErrorPayload(typeof err !== "undefined" ? err : typeof error !== "undefined" ? error : typeof stateError !== "undefined" ? stateError : typeof activityError !== "undefined" ? activityError : typeof sseError !== "undefined" ? sseError : typeof reEvalError !== "undefined" ? reEvalError : undefined), interactionId: typeof interactionId !== "undefined" ? interactionId : typeof interaction !== "undefined" ? interaction?.id : undefined, callControlId: typeof callControlId !== "undefined" ? callControlId : typeof legId !== "undefined" ? legId : undefined, queueId: typeof queueId !== "undefined" ? queueId : undefined, agentUserId: typeof targetUserIdFinal !== "undefined" ? targetUserIdFinal : typeof userId !== "undefined" ? userId : typeof user !== "undefined" ? user?.id : undefined, reason: typeof reason !== "undefined" ? reason : undefined });
...
async function resumeTranscription(callControlId) {
  try {
    const transcriptionConfig = await getTranscriptionConfigForCall(callControlId);
    if (!transcriptionConfig?.transcription_engine) {
      queuesLogger.warn("speakqueue", { ...contactCenterErrorPayload(typeof err !== "undefined" ? err : typeof error !== "undefined" ? error : typeof stateError !== "undefined" ? stateError : typeof activityError !== "undefined" ? activityError : typeof sseError !== "undefined" ? sseError : typeof reEvalError !== "undefined" ? reEvalError : undefined), interactionId: typeof interactionId !== "undefined" ? interactionId : typeof interaction !== "undefined" ? interaction?.id : undefined, callControlId: typeof callControlId !== "undefined" ? callControlId : typeof legId !== "undefined" ? legId : undefined, queueId: typeof queueId !== "undefined" ? queueId : undefined, agentUserId: typeof targetUserIdFinal !== "undefined" ? targetUserIdFinal : typeof userId !== "undefined" ? userId : typeof user !== "undefined" ? user?.id : undefined, reason: typeof reason !== "undefined" ? reason : undefined });
      return;
    }
    ...
    await Promise.all(
      legIds.map(async (legId) => {
        const url = buildTelnyxV2Url(
          `/calls/${encodeURIComponent(legId)}/actions/transcription_start`
        );
        await fetch(url, {
          method: "POST",
          headers: {
        ...
        pausedTranscriptions.delete(legId);
        queuesLogger.debug("speakqueue", { interactionId: typeof interactionId !== "undefined" ? interactionId : typeof interaction !== "undefined" ? interaction?.id : undefined, callControlId: typeof callControlId !== "undefined" ? callControlId : typeof legId !== "undefined" ? legId : undefined, queueId: typeof queueId !== "undefined" ? queueId : undefined, agentUserId: typeof targetUserIdFinal !== "undefined" ? targetUserIdFinal : typeof userId !== "undefined" ? userId : typeof user !== "undefined" ? user?.id : undefined, reason: typeof reason !== "undefined" ? reason : undefined });
      })
    );
  } catch (err) {
...
async function sendSpeak(callControlId, payload, voice, language) {
  ...
  try {
    ...
    if (!resp.ok) {
      ...
      queuesLogger.error("speakqueue", { ...contactCenterErrorPayload(typeof err !== "undefined" ? err : typeof error !== "undefined" ? error : typeof stateError !== "undefined" ? stateError : typeof activityError !== "undefined" ? activityError : typeof sseError !== "undefined" ? sseError : typeof reEvalError !== "undefined" ? reEvalError : undefined), interactionId: typeof interactionId !== "undefined" ? interactionId : typeof interaction !== "undefined" ? interaction?.id : undefined, callControlId: typeof callControlId !== "undefined" ? callControlId : typeof legId !== "undefined" ? legId : undefined, queueId: typeof queueId !== "undefined" ? queueId : undefined, agentUserId: typeof targetUserIdFinal !== "undefined" ? targetUserIdFinal : typeof userId !== "undefined" ? userId : typeof user !== "undefined" ? user?.id : undefined, reason: typeof reason !== "undefined" ? reason : undefined });
      return false;
    }
