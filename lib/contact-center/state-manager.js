...
// Keep interval handles on globalThis so Next.js dev/HMR does not start
// duplicate background loops on every module reload. Duplicate loops can create
// many concurrent Postgres queries and exhaust local max_connections.
