...
export async function recordCallSLA(
  ...
  try {
    ...
    console.error("[SLATracker] Error recording SLA metric:", error);
  }
}
...
export async function getDailySLAMetrics(queueId, date = null) {
  try {
    ...
    console.error("[SLATracker] Error getting daily SLA metrics:", error);
    return null;
  }
}
...
export async function getQueueSLACompliance(queueId, startDate, endDate) {
  try {
    ...
    console.error("[SLATracker] Error getting SLA compliance:", error);
    return null;
  }
}
...
export async function updateAverageHandleTime(queueId) {
  try {
    ...
    console.error(
      "[SLATracker] Error updating average handle time:",
      error
    );
  }
}
