...
export const queuesLogger = createDiagnosticLogger("contact-center.queues");
export const interactionsLogger = createDiagnosticLogger("contact-center.interactions");
export const wrapupLogger = createDiagnosticLogger("contact-center.wrapup");
export const transferLogger = createDiagnosticLogger("contact-center.transfer");
export const consultLogger = createDiagnosticLogger("contact-center.consult");
export const supervisionLogger = createDiagnosticLogger("contact-center.supervision");
export const webrtcBridgeLogger = createDiagnosticLogger("contact-center.interactions");
