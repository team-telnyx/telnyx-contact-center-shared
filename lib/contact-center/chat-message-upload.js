...
export async function receiveAgentChatMessage(pool,{request,workItemId,agentId}){
  const identity={workItemId,agentId},admission=await admitTextAttachment(pool,identity);
  try{
