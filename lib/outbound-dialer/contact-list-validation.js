...
const VALIDATION_MAPPING_PREFIXES = ["number:", "email:"];
...
export function contactListValidationMessage(contactList = {}) {
  ...
  if (!hasNumberOrEmailMapping(contactList)) return "Map at least one column to Number or Email before marking this contact list as validated.";
