export const OUTBOUND_CHANNELS = ["voice", "sms", "whatsapp", "email"];
// Channels executed by the messaging broadcast runner instead of the voice dialer.
export const OUTBOUND_MESSAGING_CHANNELS = ["sms", "whatsapp", "email"];
export const isOutboundMessagingChannel = (channel) => OUTBOUND_MESSAGING_CHANNELS.includes(String(channel || "").toLowerCase());
...
// Messaging campaigns run agentless: the worker sends every message and replies
// reach queues through the inbound rules of the sending number or mailbox.
export const OUTBOUND_MESSAGING_MODES = ["broadcast"];
