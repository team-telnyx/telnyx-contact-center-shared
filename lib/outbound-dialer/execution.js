...
export async function handleOutboundMachineDetection(
  ...
  if (isHuman) {
    // Connect path: nothing else to do here for agentless campaigns (the
    // handler flow/AI assistant already has the call). WS5-T3 Power mode
    // hooks agent reservation+bridge at this point.
