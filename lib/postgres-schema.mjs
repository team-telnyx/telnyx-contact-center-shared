    ...
    try {
      ...
      await client.query(`
        CREATE TABLE IF NOT EXISTS mcp_servers (
          ...
          url TEXT NOT NULL,
          auth_type TEXT NOT NULL DEFAULT 'none' CHECK (auth_type IN ('none', 'bearer', 'api_key', 'custom_header', 'oauth_client_credentials')),
        ...
        BEGIN
          ...
          ALTER TABLE mcp_servers
            ...
            CHECK (auth_type IN ('none', 'bearer', 'api_key', 'custom_header', 'oauth_client_credentials'));
        END $$;
