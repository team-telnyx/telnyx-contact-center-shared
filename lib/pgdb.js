...
export const PgDb = {
  ...
  async listAgentInteractions(agentUsernameOrFilter, filter = {}) {
    ...
    console.log(`[PgDb.listAgentInteractions] agentUsername: ${agentUsername}`);
    console.log(`[PgDb.listAgentInteractions] activatedQueueIds: ${JSON.stringify(Array.from(activatedQueueIds))}`);
    console.log(`[PgDb.listAgentInteractions] privateQueueName: ${privateQueueName}, found: ${!!privateQueue}`);
    ...
    console.log(`[PgDb.listAgentInteractions] SQL: ${q}`);
    console.log(`[PgDb.listAgentInteractions] vals: ${JSON.stringify(vals)}`);
    
    const r = await pool.query(q, vals);
    
    console.log(`[PgDb.listAgentInteractions] Found ${r.rows.length} rows`);
