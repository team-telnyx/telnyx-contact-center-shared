...
export async function startRunLoop(pool, runId) {
  ...
  const fromNumbers = Array.isArray(scenario.config.from_numbers) && scenario.config.from_numbers.length
    ? scenario.config.from_numbers
    : Array.isArray(settings.from_numbers) ? settings.from_numbers : [];
