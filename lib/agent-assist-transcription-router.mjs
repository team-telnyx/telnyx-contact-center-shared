...
export async function routeAgentAssistTranscription(payload) {
  ...
  if (isMessageFinal) {
    ...
    try {
      const { processFinalTranscriptionEnhancements } = await import("./contact-center/webhook-handler.js");
      ...
      console.warn("[AgentAssist] Final transcription enhancement import failed:", error);
    }
  }
