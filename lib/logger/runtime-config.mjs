...
export function normalizeRuntimeLoggingConfig(input = {}, { now = new Date() } = {}) {
  ...
  const config = {
    ...
    archivePrefix: normalizeStorageText(input.archivePrefix ?? input.archive_prefix ?? defaultArchivePrefix(), DEFAULT_LOGGING_CONFIG.archivePrefix).replace(/^\/+|\/+$/g, "") || DEFAULT_LOGGING_CONFIG.archivePrefix,
