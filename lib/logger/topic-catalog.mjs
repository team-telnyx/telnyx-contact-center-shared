...
export const LOGGING_TOPIC_GROUPS = Object.freeze([
  {
    ...
    topics: [
      ...
      { id: "platform.phone-provisioning", label: "Phone provisioning", description: "Hardphone provisioning, CTI config serving, and device event audit logs.", defaultLevel: "info" },
    ],
  },
  {
    id: "security",
