...
export const LOGGING_TOPIC_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    description: "Optional client-side telemetry separated from backend runtime logs.",
    defaultLevel: "warn",
    topics: [
      { id: "frontend.agent-desktop", label: "Agent Desktop", description: "Agent Desktop browser telemetry when explicitly enabled.", defaultLevel: "warn" },
      { id: "frontend.supervisor", label: "Supervisor UI", description: "Supervisor browser telemetry when explicitly enabled.", defaultLevel: "warn" },
      { id: "frontend.admin", label: "Admin UI", description: "Admin and call-flow editor browser telemetry when explicitly enabled.", defaultLevel: "warn" },
    ],
  },
]);
