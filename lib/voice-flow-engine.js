...
function resolveTelnyxSttLanguage(body = {}, providerConfig = {}, existingClientState = {}, variables = {}) {
  if (body.telnyx_stt_use_caller_language === true) {
    return existingClientState?.caller_language || providerConfig?.telnyxStt?.language || "en-US";
  }
  ...
  return body.telnyx_stt_language || providerConfig?.telnyxStt?.language || "en-US";
}
