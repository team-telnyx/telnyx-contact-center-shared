...
async function applyStreamingProviderConfiguration(body, action) {
  ...
  if (aiProvider === "azure-transcription") {
  ...
  } else if (fullProviderConfig?.type === "telnyx-stt") {
    ...
    existingClientState.telnyx_stt_config = {
      ...
      endpointing: body.telnyx_stt_endpointing || undefined,
      eot_threshold: body.telnyx_stt_eot_threshold || undefined,
      eager_eot_threshold: body.telnyx_stt_eager_eot_threshold || undefined,
      eot_timeout_ms: body.telnyx_stt_eot_timeout_ms || undefined,
      enabled: true,
...
function cleanupStreamingProviderFields(body) {
  ...
  delete body.telnyx_stt_endpointing;
  delete body.telnyx_stt_eot_threshold;
  delete body.telnyx_stt_eager_eot_threshold;
  delete body.telnyx_stt_eot_timeout_ms;
