  ...
  try {
    ...
    if (nodeType === "agent_assist") {
      const agentAssistConfig = {
        ...
        assist_type: processedConfig.assist_type || "kb_articles",
        // KB Articles options
        kb_category: processedConfig.kb_category || null,
        kb_auto_suggest: processedConfig.kb_auto_suggest !== false,
        kb_max_suggestions: processedConfig.kb_max_suggestions || 3,
        // Workflow options
        workflow_id: processedConfig.workflow_id || null,
        auto_start: processedConfig.auto_start !== false,
        show_suggestions: processedConfig.show_suggestions !== false,
        auto_detect_completion: processedConfig.auto_detect_completion !== false,
      };
