...
export async function logCallEvent(webhookData) {
  try {
    ...
    try {
      ...
      if (err.code === "42P01") {
        voiceRuntimeLogger.debug("runtime_debug", { ...runtimePayload({ error: typeof error !== "undefined" ? error : typeof err !== "undefined" ? err : undefined, status: typeof status !== "undefined" ? status : undefined }) });
        return null;
      }
