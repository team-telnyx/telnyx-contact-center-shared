...
const TELNYX_MCP_OAUTH_TOKEN_ENDPOINT = "https://api.telnyx.com/v2/oauth/token";
...
async function requestOAuthToken({ tokenSession, params }) {
  const tokenEndpoint = tokenSession.token_endpoint || (tokenSession.resource === TELNYX_MCP_RESOURCE ? TELNYX_MCP_OAUTH_TOKEN_ENDPOINT : null);
