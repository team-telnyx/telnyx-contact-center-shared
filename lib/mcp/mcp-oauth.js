...
function applyOAuthClientAuth({ headers, body, tokenSession, grantType }) {
  ...
  // Telnyx dynamic clients are registered as public PKCE clients with
  // token_endpoint_auth_method="none". Refresh requests for these clients
  // must not send Basic auth or client_id; Telnyx returns invalid_client.
