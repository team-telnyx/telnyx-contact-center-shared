export const FORM_COMPONENT_TYPES = ["section", "row", "columns", "grid", "label", "text", "textarea", "select", "radio", "checkbox", "button", "image", "context_value", "hidden"];
export const FORM_COMPONENT_REGISTRY = {
  section: { label: "Section", data: false }, row: { label: "Row", data: false }, columns: { label: "Columns", data: false }, grid: { label: "Grid", data: false },
