 ...
 * @param {string} [options.model] - AI model (default: moonshotai/Kimi-K2.5)
 * @returns {Promise<Object|null>} Scenario { id, name, description, responses } or null
 */
export async function generateTestScenario({ workflow, scenarioType = "workflow_specific", model = "moonshotai/Kimi-K2.5" }) {
