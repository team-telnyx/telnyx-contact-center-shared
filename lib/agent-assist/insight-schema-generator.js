...
export function generateSlotsInstructions(workflow, stages) {
  ...
  instructions += `2. **IMPORTANT: If information was not provided or is unclear, OMIT the slot entirely from the output. Do NOT set value to the string "null" or "None".**\n`;
  instructions += `3. Only include slots where you found actual information.\n`;
  instructions += `4. Confidence scoring:\n`;
  ...
  instructions += `   - **< 0.6** = OMIT the slot entirely\n`;
  instructions += `5. Include the exact source_utterance where the value was mentioned.\n`;
  instructions += `6. For completed_stages, list only stages where ALL slot items were addressed.\n`;
  instructions += `7. Normalize values appropriately:\n`;
