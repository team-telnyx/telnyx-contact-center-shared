...
class TelnyxSttRealtimeSession {
  ...
  buildUrl() {
    ...
    if (this.config.endpointing !== undefined && this.config.endpointing !== "") params.set("endpointing", String(this.config.endpointing));
    if (this.config.eot_threshold !== undefined && this.config.eot_threshold !== "") params.set("eot_threshold", String(this.config.eot_threshold));
    if (this.config.eager_eot_threshold !== undefined && this.config.eager_eot_threshold !== "") params.set("eager_eot_threshold", String(this.config.eager_eot_threshold));
    if (this.config.eot_timeout_ms !== undefined && this.config.eot_timeout_ms !== "") params.set("eot_timeout_ms", String(this.config.eot_timeout_ms));
