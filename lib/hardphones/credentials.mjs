...
function outboundCallerIdPatch(phoneNumber, { clearEmpty = false } = {}) {
  ...
  if (clearEmpty) {
    // Telnyx does not accept nullable outbound caller-ID fields on credential
    // connection PATCH requests. When a phone number is removed, the number
    // unassignment is handled separately; avoid sending an invalid cleanup PATCH.
    return {};
  }
  return {};
}
