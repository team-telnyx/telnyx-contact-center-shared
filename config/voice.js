export const TRANSCRIPTION_PROVIDERS = [
  ...
  },
  {
    ...
    // Telnyx Voice API in-call transcription accepts base language hints here
    // (for example "en"). Locale values such as "en-US" are valid in some
    // assistant/streaming contexts but are rejected by call answer/start.
    languages: [
      "af",
      "am",
      "ar",
