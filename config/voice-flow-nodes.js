...
export const VOICE_FLOW_NODES = {
  ...
  client_state_update: {
    ...
    customEditor: "ClientStateUpdateNodeEditor",
    config: {
      update_mode: {
        type: "select",
        label: "Update Mode",
        required: true,
        default: "predefined",
        options: ["predefined", "custom", "raw_json"],
        description: "Builds a JSON client_state patch and Base64-encodes it automatically.",
      },
      predefined_key: {
        type: "select",
        label: "Predefined Parameter",
        required: false,
        default: "caller_language",
        options: ["caller_language"],
      },
      caller_language: {
        type: "string",
        ...
        required: false,
        default: "en-US",
        description: "Caller spoken language used by Agent Assist online translation.",
      },
      value_source: {
        type: "select",
        label: "Value Source",
      ...
      client_state: {
        type: "string",
        label: "Legacy Client State",
        required: false,
        description: "Legacy Base64 client_state value. New flows should use the friendly builder fields above.",
      },
    },
  },
  ...
  transcription_start: {
    ...
    inputs: 1,
    outputs: 2,
    outputLabels: ["Transcribing", "Failed"],
    outputEvents: [],
    outputDescriptions: [
      "Transcription start command accepted by Telnyx",
      "Transcription start command failed",
    ],
  ...
  agent_assist: {
    ...
    config: {
      ...
      enable_intent_recognition: {
        type: "boolean",
        label: "Enable Intent Recognition",
        required: false,
        default: false,
        description: "Detect intent for finalized transcription messages",
        showWhen: { assist_type: "workflows" },
      },
  ...
  mcp_tool: {
    ...
    config: {
      ...
      input: {
        ...
        required: false,
        default: "{}",
        description: "Schema-shaped MCP tool arguments. Supports {{variable}} references with type preservation for pure variables.",
      },
      toolInputSchema: {
        type: "json",
        ...
        required: false,
        default: null,
        description: "Cached input schema assigned to the selected tool for validation and UI rendering.",
      },
      responseVariable: {
        type: "string",
        label: "Response Variable Name",
